        ...
        <footer className="bg-white border-t border-slate-100 py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
                ...
                <nav className="flex items-center gap-4 sm:gap-6 text-sm font-medium text-slate-600 flex-wrap justify-center">
                    ...
                    <a href="https://isglifestudio.kr/feed.xml" target="_blank" rel="noopener noreferrer" className="hover:text-blue-600 transition-colors py-1" title="RSS Feed">
                        RSS
                    </a>
                    <a href="https://isglifestudio.kr/sitemap.xml" target="_blank" rel="noopener noreferrer" className="hover:text-blue-600 transition-colors py-1" title="Sitemap">
                        Sitemap
                    </a>
                </nav>
                </div>
