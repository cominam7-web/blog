                ...
                <div className="flex justify-between items-center pb-4 sm:pb-6">
                    ...
                    <div className="flex items-center gap-3 sm:gap-6 text-slate-900 ml-4">
                        ...
                        <div className="hidden md:flex items-center gap-3">
                            ...
                            <a href="https://pf.kakao.com/_aWxnZX" target="_blank" rel="noopener noreferrer" className="w-7 h-7 border-2 border-slate-900 rounded-full flex items-center justify-center hover:bg-[#FEE500] hover:border-[#FEE500] transition-colors" aria-label="카카오 채널">
